#!/bin/bash
#SBATCH --job-name=energygt_inverse20_simple-patched_patch20
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=72:00:00
#SBATCH --output=logs/energygt_inverse20_simple-patched_patch20_%j.out
#SBATCH --error=logs/energygt_inverse20_simple-patched_patch20_%j.err

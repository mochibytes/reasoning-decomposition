...
for sharpness in 0.6 0.7 0.8 0.9 1.0 2.0 3.0
do
  ...
  srun python3 train.py \
    ...
    --results_filename ~/reasoning-decomposition/results/uniform_t/sharpness_test_inverse_r20_patch20_sharp${sharpness}_endstart.csv
done
